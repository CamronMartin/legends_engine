...
void Game::LoadLevel(int level) {
  ...
  chopper.AddComponent<KeyboardControlComponent>(glm::vec2(0, -100), glm::vec2(100, 0), glm::vec2(0, 100),
                                                 glm::vec2(-100, 0));
  ...
  label.AddComponent<TextLabelComponent>(glm::vec2(windowWidth / 2 - 40, 50), "CHOPPER 1.0", "charriot-font", green,
                                         true);
}
